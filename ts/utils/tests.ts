...
import backendInfoReducer from "../store/reducers/backendInfo";
...
import emailValidationReducer from "../store/reducers/emailValidation";
import entitiesReducer, { EntitiesState } from "../store/reducers/entities";
...
import { entitiesPersistConfig } from "../store/reducers";
...
export const mockNavigation = (myParams: any, cb: () => unknown) => {
  const navigation: any = {
    ...
    getParam: (field: string) => navigation.state.params[field]
  };
  return navigation;
};

// Combine needed reducers avoiding persistence
export const testRootReducer: Reducer<any, any> = combineReducers<any, any>({
  //
